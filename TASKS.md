...
- [~] P021 Complete title/content search, projects, tags, archived visibility, pinning, batch delete/move/archive, and adaptive/LLM title regeneration (batch archive/delete now preserve successful actions and report failed session IDs; move/import/title regeneration remain)
