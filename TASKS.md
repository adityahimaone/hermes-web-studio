...
- [~] P006 Match the Chat session panel: WebUI/CLI sources, content search, project chips, date groups, archive/pin, channel badges, batch mode, and overflow actions (source/project/channel/batch UI, server-backed transcript search, duplicate, Markdown export, and ArrowUp/ArrowDown session selection implemented; import/share remain)
