...
- [~] Edit/regenerate/retry and queue while processing (server-side edit truncation, retry, and queued text/attachment delivery implemented and browser-verified; live edit/retry parity proof remains)
