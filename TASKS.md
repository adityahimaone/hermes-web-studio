...
- [~] P057 Run visual matrices across required viewports, System/Dark/Light, all release skins, long lists/transcripts, active streaming, dialogs, and both side panels (252 local viewport/theme/skin rows pass with screenshots outside repo; rail icon scale, session header wrapping, and compact toolbar typography pass locally; long/live/reference pixel rows remain)
