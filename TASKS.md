...
- [~] P045 Complete Control Center Conversation, Appearance, Preferences, Providers, Plugins, Extensions, System, and Help sections with searchable settings (capability section registry, Settings navigation rail, non-JSON-safe loading, scoped capability visibility, and bottom-anchored Settings navigation added; complete section behavior/search remains)
