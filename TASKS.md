...
- [~] P067 Promote the shared ContextRail and seam collapse control to the full Chat, Skills, Memory, Profiles, and Settings layout shell (Chat, Skills, Memory, and Settings shared rail slices are implemented and bounded shell geometry is covered; Profiles and a single page-layout-owned seam control remain)
